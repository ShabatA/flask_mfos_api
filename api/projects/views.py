...
stage_namespace = Namespace(
    "Project Stages", description="A namespace for Project Stages"
)
task_namespace = Namespace("Project Tasks", description="A namespace for Project Tasks")
assessment_namespace = Namespace(
    "Project Assessment", description="A namespace for Project Assessment"
)

requirements_namespace = Namespace(
    "Requirements",
    description="A namespace for requirements. These will be universal for both Case and Project Approval",
)

activity_namespace = Namespace(
    "Activities",
    description="A namespace for stand-alone activities and activities linked to programs",
)
...
requirements_model = requirements_namespace.model(
    "Requirement",
    {
        "name": fields.String(
            required=True, description="The name of the requirement."
        ),
        "description": fields.String(
            required=True,
            description="Short details to give an idea of what the underlying task will be.",
        ),
        "section": fields.String(
            enum=["FINANCIAL", "IMPLEMENTATION", "MEDIA"],
            description="The section these requirements belong to.",
        ),
    },
)

answers_model = project_namespace.model(
    "Answers",
    {
...
comments_model = task_namespace.model(
    "TaskComments",
    {
...
edit_comments_model = task_namespace.model(
    "EditTaskComments",
    {
...
assessment_question_model = assessment_namespace.model(
    "AssessmentQuestion",
    {
...
assessment_answer_model = assessment_namespace.model(
    "AssessmentAnswer",
    {
...
assessment_model = assessment_namespace.model(
    "ProjectAssessment",
    {
...
checklist_model = task_namespace.model(
    "CheckListItem",
    {
        "item": fields.String(
...
activity_model = activity_namespace.model(
    "ActivityInput",
    {
        ...
        "assignedTo": fields.List(
            fields.Integer, description="List of user IDs assigned to the activity"
        ),
    },
)

edit_activity_model = activity_namespace.model(
    "EditActivity",
    {
...
activity_stat = activity_namespace.model(
    "ActivityStatusData",
    {
...
new_task_model = task_namespace.model(
    "NewTaskModel",
    {
...
assign_task = task_namespace.model(
    "AssignTask",
    {
        "assigned_to": fields.List(
            fields.Integer, description="List of user IDs assigned to the task"
...
edit_task_model = task_namespace.model(
    "EditTaskModel",
    {
        "title": fields.String(required=True, description="Title of the task"),
        "deadline": fields.Date(
...
project_input_model = project_namespace.model(
    "ProjectInput",
    {
        ...
        "budgetRequired": fields.Float(
            required=True, description="Required budget for the project"
        ),
        "projectScope": fields.String(description="Scope of the project"),
        "category": fields.String(
            enum=["A", "B", "C", "D"], description="Category of the project"
        ),
        "userID": fields.Integer(
            description="ID of the user associated with the project"
        ),
        "answers": fields.List(
            fields.Nested(answers_model), description="List of answers for the project"
        ),
    },
)

projects_data_model = project_namespace.model(
    "ProjectsDataInput",
    {
        "projectName": fields.String(required=True, description="Name of the project"),
        "regionID": fields.Integer(required=True, description="ID of the region"),
        ...
        "projectIdea": fields.String(
            description="Idea and justification of the project"
        ),
        ...
        "beneficiaryCategory": fields.Integer(
            description="Beneficiary category of the project"
        ),
        "commitment": fields.Integer(
            description="Is there a commitment from external party"
        ),
        "commitmentType": fields.Integer(description="Commitment type"),
        "supportingOrg": fields.String(
            description="Details of the supporting organization"
        ),
        "documents": fields.List(fields.String, description="List the document types"),
        "recommendationLetter": fields.Integer(
            description="Is there a recomemendation letter"
        ),
        "projectType": fields.String(
            enum=[type.value for type in ProType],
            required=True,
            description="Project or Program",
        ),
    },
)

project_update_status_model = project_namespace.model(
    "ProjectUpdateStatus",
    {
        ...
        "status_data": fields.Raw(
            description="Status data associated with the project"
        ),
    },
)

project_input_model2 = project_namespace.model(
    "ProjectInput2",
    {
        "status_data": fields.Raw(
            description="Status data associated with the project"
...
project_status = project_namespace.model(
    "ProjectStatus",
    {
        "projectStatus": fields.String(
            required=True,
...
edited_answers_model = project_namespace.model(
    "EditedAnswers",
    {
...
edit_choice_with_choice_id = project_namespace.model(
    "EditChoiceWithChoiceID",
    {"choiceID": fields.Integer(description="ID of the added choice")},
)

project_edit_model = project_namespace.model(
    "ProjectEdit",
    {
        "edited_answers": fields.List(
            fields.Nested(edited_answers_model),
            description="List of edited answers for the project",
        )
    },
)

project_edit_details_model = project_namespace.model(
    "ProjectEditDetails",
    {
        "projectName": fields.String(required=True, description="Name of the project"),
        "regionID": fields.Integer(required=True, description="ID of the region"),
...
question_input_model = project_namespace.model(
    "QuestionInput",
    {
        "questionText": fields.String(
...
# Define a model for the input data (assuming JSON format)
link_project_to_stage_model = stage_namespace.model(
    "LinkProjectToStageModel",
    {
        ...
        "completed": fields.Boolean(
            required=True, description="If the stages completed"
        ),
        "completionDate": fields.Date(description="Completion Date"),
    },
)

regions_data_model = project_namespace.model(
    "RegionData",
    {
...
users_data_model = project_namespace.model(
    "UserData",
    {
...
projects_result_model = project_namespace.model(
    "ProjectsData",
    {
        ...
        "region": fields.Nested(
            regions_data_model, description="Details of the region"
        ),
        ...
        "recommendationLetter": fields.Integer(
            description="Is there a recommendation letter"
        ),
...
class ProjectAddResource(Resource):
    ...
    def post(self):
        ...
        existing_project = ProjectsData.query.filter_by(
    ...
    def put(self):
        try:
            ...
            if not project_id:
                return {
                    "message": "Project ID is required for updating a project"
            ...
            existing_project.beneficiaryCategory = project_data.get(
                "beneficiaryCategory"
            )
            ...
            existing_project.recommendationLetter = project_data.get(
                "recommendationLetter"
            )
            existing_project.project_type = project_data.get(
                "projectType", existing_project.project_type
            )
            existing_project.active = project_data.get(
            ...
            return {
                ...
                "project_id": existing_project.projectID,
            }, HTTPStatus.OK
        except Exception as e:
            ...
            if not current_user.is_admin():
                ...
                projects = (
                    ProjectsData.query.join(
                        Users, Users.userID == ProjectsData.createdBy
                    )
        ...
        try:
            ...
            if not current_user.is_admin():
                ...
                projects = (
                    ...
                    .filter(
                        Users.userID == current_user.userID,
                        ProjectsData.projectStatus == Status.APPROVED,
                    )
                    .all()
                )
                ...
                project_user_projects = (
                    ...
                    .filter(
                        ProjectUser.userID == current_user.userID,
                        ProjectsData.projectStatus == Status.APPROVED,
                    )
                    .all()
                )
            ...
            return [
                project.approved_serialize() for project in all_projects
            ], HTTPStatus.OK
...
class ProjectAddRequirementsResource(Resource):
    ...
    def post(self, project_id):
        try:
            ...
            return {
                "message": "Project requirements added successfully"
            }, HTTPStatus.CREATED
        except Exception as e:
            # Handle exceptions (e.g., database errors) appropriately
            return {
                "message": f"Error adding project requirements: {str(e)}"
            }, HTTPStatus.INTERNAL_SERVER_ERROR
    ...
    def put(self, program_id):
        try:
            ...
            if (
                ...
                return {
                    "message": "Unauthorized. Only admin users can convert programs."
                }, HTTPStatus.FORBIDDEN

            program = ProjectsData.get_by_id(program_id)
            if program.project_type != ProType.PROGRAM:
                return {
                    "message": "Denied. This is not a program. projects cannot be deactivated."
                }, HTTPStatus.BAD_REQUEST
            ...
            # Handle exceptions (e.g., database errors) appropriately
            return {
                "message": f"Error converting project: {str(e)}"
            }, HTTPStatus.INTERNAL_SERVER_ERROR
...
class ActivateProgramResource(Resource):
    ...
    def put(self, program_id):
        try:
            ...
            if program.project_type != ProType.PROGRAM:
                return {
                    "message": "Denied. This is not a program. projects cannot be reactivated."
                }, HTTPStatus.BAD_REQUEST
    ...
    def post(self, project_id):
        try:
            ...
            if (
                ...
                return {
                    "message": "Unauthorized. Only admin users can convert projects."
                }, HTTPStatus.FORBIDDEN

            project = ProjectsData.get_by_id(project_id)
            if project.project_type != ProType.PROJECT:
                return {
                    "message": "Denied. The Project is already a program."
                }, HTTPStatus.BAD_REQUEST
            # Parse the input data
            project_data = request.json
            status_data = project_data.pop(
            ...
            processor = ProjectRequirementProcessor(
                project.projectID, current_user.userID
            )
            # call the corresponding function to handle making a Task for that requirement
            for value in requirementsList:
                function_name = f"requirement_{value}"
...
class ProjectChangeStatusResource(Resource):
    @jwt_required()
    @project_namespace.expect(
        project_namespace.model(
            "ProjectStatus",
            {
                "projectStatus": fields.String(
                    required=True, description="New project status"
                )
            },
        )
    )
        ...
        if current_user.is_admin() or current_user.userID == project.userID:
            ...
            try:
                ...
                if new_status == "APPROVED":
                    ...
                    initiated_stage = Stage.query.filter_by(
                    ...
                    project_stages = [
                        ProjectStage(
                            project=project, stage=initiated_stage, started=True
                        ),
                        ProjectStage(
                            project=project, stage=progress_stage, started=True
                        ),
                ...
                db.session.rollback()
                return {
                    "message": f"Error changing project status: {str(e)}"
                }, HTTPStatus.INTERNAL_SERVER_ERROR
        else:
            return {
                "message": "Unauthorized. You do not have permission to change the status of this project."
            }, HTTPStatus.FORBIDDEN
...
class ProjectUsersResource(Resource):
    ...
    def get(self, project_id):
        ...
        if current_user.is_admin() or current_user in project.users:
            ...
            return {
                "message": "Unauthorized. You do not have permission to view users for this project."
            }, HTTPStatus.FORBIDDEN
    ...
    def get(self, project_id):
        try:
            ...
            current_app.logger.error(
                f"Error retrieving linked stages for project: {str(e)}"
            )
            return {
                "message": "Internal Server Error"
            }, HTTPStatus.INTERNAL_SERVER_ERROR
...
@stage_namespace.route(
    "/complete_stage_for_project/<int:project_id>/<int:stage_id>", methods=["PUT"]
)
@stage_namespace.doc(
    params={
...
class CompleteStageForProjectResource(Resource):
    ...
    def put(self, project_id, stage_id):
        try:
            ...
            linked_stage = ProjectStage.query.filter_by(
                projectID=project_id, stageID=stage_id
            ).first()

            if linked_stage is None:
                return {
                    "message": "Stage not linked to the specified project"
                }, HTTPStatus.NOT_FOUND
...
@stage_namespace.route(
    "/remove_stage/<int:project_id>/<int:stage_id>", methods=["DELETE"]
)
...
@task_namespace.route(
    "/add_task_for_stage/<int:project_id>/<int:stage_id>", methods=["POST"]
)
...
class GetTasksForProgramResource(Resource):
    ...
    def get(self, project_id):
        try:
            ...
            program_tasks = ProjectTask.query.filter_by(projectID=project_id, stageID=None).all()
...
class AssignTaskResource(Resource):
    ...
    def put(self, task_id):
        ...
        if (
            ...
            return {
                "message": "Unauthorized. Only admin users can edit Task details."
            }, HTTPStatus.FORBIDDEN
...
class MarkTaskAsDoneResource(Resource):
    @jwt_required()
    @task_namespace.doc(description="Assign the DONE status to the provided task.")
    def put(self, task_id):
        try:
            task = ProjectTask.get_by_id(task_id)
            #
            if (
                task.status == TaskStatus.INPROGRESS
                or task.status == TaskStatus.OVERDUE
            ):
...
class DeleteTaskResource(Resource):
    @jwt_required()
    @task_namespace.doc(description="Delete the task.")
...
class MarkTaskAsOverdueResource(Resource):
    @jwt_required()
    @task_namespace.doc(description="Assign the OVERDUE status to the provided task")
    def put(self, task_id):
        try:
            task = ProjectTask.get_by_id(task_id)
...
class AddTaskComments(Resource):
    ...
    @task_namespace.doc(description="Post comments to a Task")
    def post(self):
        # Get the current user ID from the JWT token
        current_user = Users.query.filter_by(username=get_jwt_identity()).first()
...
class EditTaskComments(Resource):
    ...
    @task_namespace.doc(description="Edit a comment for a Task")
    def put(self):
        # Get the current user ID from the JWT token
        current_user = Users.query.filter_by(username=get_jwt_identity()).first()
        ...
        try:
            ...
            for answer in answers_data:
                ...
                existing_answer = AssessmentAnswers.query.filter_by(
                    questionID=question_id, projectID=assessment_data["projectID"]
                ).first()
            ...
            assessment_answers = (
                AssessmentAnswers.query.join(AssessmentQuestions)
                .filter(AssessmentAnswers.projectID == assessment_data["projectID"])
                .add_columns(
                    AssessmentQuestions.questionText,
                    AssessmentAnswers.answerText,
                    AssessmentAnswers.notes,
                )
                .all()
            )

            # Convert the list of answers to a JSON response
            answers_data = [answer.answerText for answer in assessment_answers]
...
class CalculateCategoryResource(Resource):
    def put(self, project_id):
        try:
            ...
            categoryCalculator.calculateCategory()
            return {
                "message": f"Calculation Complete. Category is {project.category.value} and total points is {project.totalPoints}"
            }, HTTPStatus.OK
        except Exception as e:
            print(e)
...
@task_namespace.route(
    "/get_tasks_for_stage/<int:project_id>/<int:stage_id>", methods=["GET"]
)
    ...
    def get(self, project_id, stage_id):
        try:
            ...
            for task in tasks:
                ...
                comments = (
                    TaskComments.query.filter_by(taskID=task.taskID).limit(5).all()
                )
...
@task_namespace.route("/get_tasks_for_user/<int:project_id>", methods=["GET"])
class GetTasksForProjectForUserResource(Resource):
    @jwt_required()
    def get(self, project_id):
        try:
            # Get the current user from the JWT token
            ...
            # Fetch all tasks for the project that are assigned to the current user
            tasks = ProjectTask.query.filter(
                ProjectTask.projectID == project_id,
                ProjectTask.assignedTo.any(userID=current_user.userID)
            ).all()
            ...
            for task in tasks:
                # Fetch the first 5 comments for each task
                comments = (
                    TaskComments.query.filter_by(taskID=task.taskID)
            ...
            current_app.logger.error(f"Error getting tasks for current user in project: {str(e)}")
            return {
                "message": "Internal Server Error"
            }, HTTPStatus.INTERNAL_SERVER_ERROR
...
class AddorEditActivityResource(Resource):
    ...
    def post(self):
        try:
            ...
            if programID != 0:
                ...
                if program.project_type != ProType.PROGRAM:
                    return {
                        "message": "The provided program ID is not a program, but a Project"
                    }, HTTPStatus.BAD_REQUEST
            ...
            return {
                ...
                "activity_data": {
                    ...
                    "program": (
                        ProjectsData.query.get(programID).projectName
                        if programID != 0
                        else "Out Of Program"
                    ),
    ...
    def put(self):
        ...
        try:
            ...
            if act_id is None:
                return {
                    "message": "Activty ID is required for updating an activity"
                }, HTTPStatus.BAD_REQUEST
            ...
            activity.costRequired = activity_data.get(
            ...
            if len(assigned_users) != 0:
                assigned_to_users = Users.query.filter(
                    Users.userID.in_(assigned_users)
                ).all()
            ...
            return {
                ...
                "activity_data": {
                    ...
                    "createdAt": activity.createdAt.isoformat(),
                    "program": (
                        ProjectsData.query.get(activity.programID).projectName
                        if activity.programID != None
                        else "None"
                    ),
...
class GetAllActivitiesResource(Resource):
    ...
    def get(self):
        ...
        try:
            ...
            if not current_user.is_admin():
                ...
                created_activities = Activities.query.filter_by(
                    createdBy=current_user.userID
                ).all()
            ...
            activities_dict = [
                {
                    ...
                    "deadline": (
                        activity.deadline.strftime("%Y-%m-%d")
    ...
    def get_program_details(self, programID):
        ...
        return {
            ...
            "startDate": (
                program.startDate.strftime("%Y-%m-%d") if program.startDate else None
            ),
    ...
    def get_region(self, regionID):
        return {
            "regionID": regionID,
            "regionName": Regions.query.get(regionID).regionName,
        }
...
class ChangeActivityStatusResource(Resource):
    ...
    def put(self, activityID):
        try:
            ...
            if not current_user.is_admin():
                return {
                    "message": "Only admins can change activity status"
                }, HTTPStatus.FORBIDDEN
...
@activity_namespace.route("/get/single/<int:activityID>", methods=["GET"])
class GetSingleActivityResource(Resource):
    @jwt_required()
    def get(self, activityID):
        try:
            activity = Activities.query.get_or_404(activityID)

            return activity.serialize(), HTTPStatus.OK
        except Exception as e:
            current_app.logger.error(f"Error getting activity: {str(e)}")
            return {
                "message": "Internal Server Error"
            }, HTTPStatus.INTERNAL_SERVER_ERROR


@project_namespace.route("/get/single/<int:projectID>", methods=["GET"])
class GetSingleProjectResource(Resource):
    @jwt_required()
    def get(self, projectID):
        try:
            project = ProjectsData.query.get_or_404(projectID)
