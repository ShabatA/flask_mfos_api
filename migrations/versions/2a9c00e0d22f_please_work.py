...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("TODO", "INPROGRESS", "DONE", "OVERDUE", name="casetaskstatus"),
            nullable=False,
        ),
    ...
    with op.batch_alter_table("cases", schema=None) as batch_op:
        batch_op.add_column(
            sa.Column(
                "category",
                sa.Enum("A", "B", "C", "D", name="casecategory"),
                nullable=True,
            )
        )
...
def downgrade():
    ...
    with op.batch_alter_table("cases", schema=None) as batch_op:
        batch_op.add_column(
            sa.Column("caseCategory", sa.VARCHAR(), autoincrement=False, nullable=True)
        )
        batch_op.alter_column(
            "budgetAvailable",
