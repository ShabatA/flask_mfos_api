...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "paymentFor", sa.Enum("CASE", "OTHER", name="paymentfor"), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "stage",
            sa.Enum("ASSESSMENT", "ONGOING", "APPROVED", name="transferstage"),
            nullable=True,
        ),
        sa.Column("notes", sa.Text(), nullable=True),
