...
def upgrade():
    ...
    projectscopes = sa.Enum('HEALTH', 'SHELTER', 'EDUCATION', 'GENERAL', 'SPONSORSHIP', 'RELIEF', name='projectscopes')
    ...
    with op.batch_alter_table('representatives', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_representatives_donorID'), ['donorID'], unique=False)

    op.create_table('region_account_currency_balances',
    ...
    sa.ForeignKeyConstraint(['currencyID'], ['currencies.currencyID'], ),
    sa.PrimaryKeyConstraint('balanceID')
    )
    op.create_table('financial_fund_currency_balances',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    with op.batch_alter_table('financial_fund_currency_balances', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_financial_fund_currency_balances_currencyID'), ['currencyID'], unique=False)
        batch_op.create_index(batch_op.f('ix_financial_fund_currency_balances_fundID'), ['fundID'], unique=False)

    op.create_table('region_account_transactions',
    ...
    with op.batch_alter_table('sub_funds', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_sub_funds_currencyID'), ['currencyID'], unique=False)
        batch_op.create_index(batch_op.f('ix_sub_funds_fundID'), ['fundID'], unique=False)

    op.create_table('sub_fund_currency_balances',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('subFundID', sa.Integer(), nullable=False),
    sa.Column('currencyID', sa.Integer(), nullable=False),
    sa.Column('totalFund', sa.Float(), nullable=False),
    ...
    sa.Column('availableFund', sa.Float(), nullable=False),
    sa.ForeignKeyConstraint(['currencyID'], ['currencies.currencyID'], ),
    sa.ForeignKeyConstraint(['subFundID'], ['sub_funds.subFundID'], ),
    sa.PrimaryKeyConstraint('id'),
    ...
    with op.batch_alter_table('sub_fund_currency_balances', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_sub_fund_currency_balances_currencyID'), ['currencyID'], unique=False)
        batch_op.create_index(batch_op.f('ix_sub_fund_currency_balances_subFundID'), ['subFundID'], unique=False)
    ...
    with op.batch_alter_table('donations', schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column('projectScope', sa.Enum('HEALTH', 'SHELTER', 'EDUCATION', 'GENERAL', 'SPONSORSHIP', 'RELIEF', name='projectscopes'), nullable=True))
        batch_op.add_column(sa.Column('allocationTags', sa.String(), nullable=True))
        batch_op.alter_column('donationType',
    ...
    with op.batch_alter_table('donors', schema=None) as batch_op:
        batch_op.add_column(sa.Column('donorName', sa.String(length=255), nullable=False))
        batch_op.add_column(sa.Column('placeOfResidence', sa.String(length=255), nullable=True))
        batch_op.add_column(sa.Column('startOfRelationship', sa.Date(), nullable=False))
        batch_op.add_column(sa.Column('notes', sa.Text(), nullable=True))
        batch_op.alter_column('donorType',
               existing_type=sa.VARCHAR(),
               nullable=False)
    ...
    with op.batch_alter_table('financial_fund', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_financial_fund_currencyID'), ['currencyID'], unique=False)
        batch_op.create_foreign_key(None, 'currencies', ['currencyID'], ['currencyID'])
    ...
    with op.batch_alter_table('fund_transfer_requests', schema=None) as batch_op:
        batch_op.add_column(sa.Column('transferType', sa.Enum('EFT', 'CASH', 'CHECK', name='paymentmethod'), nullable=True))
    ...
    with op.batch_alter_table('region_account', schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column('availableFund', sa.Numeric(precision=10, scale=2), nullable=False))
        batch_op.add_column(sa.Column('lastUpdate', sa.DateTime(), nullable=False))
        batch_op.alter_column('totalFund',
               existing_type=sa.DOUBLE_PRECISION(precision=53),
               type_=sa.Numeric(precision=10, scale=2),
               existing_nullable=False)
        batch_op.alter_column('usedFund',
               existing_type=sa.DOUBLE_PRECISION(precision=53),
               type_=sa.Numeric(precision=10, scale=2),
               existing_nullable=False)
        batch_op.alter_column('health_funds',
               existing_type=sa.DOUBLE_PRECISION(precision=53),
               type_=sa.Numeric(precision=10, scale=2),
               existing_nullable=True)
        batch_op.alter_column('education_funds',
               existing_type=sa.DOUBLE_PRECISION(precision=53),
               type_=sa.Numeric(precision=10, scale=2),
               existing_nullable=True)
        batch_op.alter_column('general_funds',
               existing_type=sa.DOUBLE_PRECISION(precision=53),
               type_=sa.Numeric(precision=10, scale=2),
               existing_nullable=True)
        batch_op.alter_column('shelter_funds',
               existing_type=sa.DOUBLE_PRECISION(precision=53),
               type_=sa.Numeric(precision=10, scale=2),
               existing_nullable=True)
        batch_op.alter_column('sponsorship_funds',
               existing_type=sa.DOUBLE_PRECISION(precision=53),
               type_=sa.Numeric(precision=10, scale=2),
               existing_nullable=True)
        batch_op.create_foreign_key(None, 'currencies', ['defaultCurrencyID'], ['currencyID'])
        batch_op.drop_column('currency')
...
def downgrade():
    ...
    with op.batch_alter_table('region_account', schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column('lastTransation', sa.DATE(), autoincrement=False, nullable=True))
        batch_op.add_column(sa.Column('accountType', sa.VARCHAR(), autoincrement=False, nullable=True))
        batch_op.add_column(sa.Column('currency', sa.VARCHAR(), autoincrement=False, nullable=True))
    ...
    with op.batch_alter_table('payments', schema=None) as batch_op:
        batch_op.add_column(sa.Column('exchangeRate', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True))
        batch_op.add_column(sa.Column('supportingFiles', sa.VARCHAR(), autoincrement=False, nullable=True))
        batch_op.add_column(sa.Column('currency', sa.VARCHAR(), autoincrement=False, nullable=True))
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.alter_column('paymentMethod',
    ...
    with op.batch_alter_table('fund_transfer_requests', schema=None) as batch_op:
        batch_op.add_column(sa.Column('exchangeRate', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True))
        batch_op.add_column(sa.Column('currencyTo', sa.VARCHAR(), autoincrement=False, nullable=True))
        batch_op.add_column(sa.Column('currencyFrom', sa.VARCHAR(), autoincrement=False, nullable=True))
        batch_op.add_column(sa.Column('attachedFiles', sa.VARCHAR(), autoincrement=False, nullable=True))
    ...
    with op.batch_alter_table('donations', schema=None) as batch_op:
        batch_op.add_column(sa.Column('field', sa.VARCHAR(), autoincrement=False, nullable=True))
        batch_op.add_column(sa.Column('currency', sa.VARCHAR(), autoincrement=False, nullable=True))
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.alter_column('donationType',
    ...
    with op.batch_alter_table('financial_fund_currency_balances', schema=None) as batch_op:
        ...
        batch_op.drop_index(batch_op.f('ix_financial_fund_currency_balances_currencyID'))
