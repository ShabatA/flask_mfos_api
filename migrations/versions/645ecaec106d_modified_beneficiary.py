...
def downgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "paymentID",
            sa.INTEGER(),
            server_default=sa.text("nextval('\"payments_paymentID_seq\"'::regclass)"),
            autoincrement=True,
            nullable=False,
        ),
        ...
        sa.Column(
            "paymentFor",
            postgresql.ENUM("CASE", "OTHER", name="paymentfor"),
            autoincrement=False,
            nullable=False,
        ),
        ...
        sa.ForeignKeyConstraint(
            ...
            name="payments_currencyID_fkey",
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["from_fund"],
            ["financial_fund.fundID"],
            name="payments_from_fund_fkey",
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["subFundID"],
            ["sub_funds.subFundID"],
            name="payments_subFundID_fkey",
            ondelete="CASCADE",
        ),
