...
def upgrade():
    ...
    sa.Column('projectStatus', sa.Enum('PENDING', 'APPROVED', 'REJECTED', name='projectstatus'), nullable=False),
    sa.Column('projectScope', sa.String(), nullable=True),
    sa.Column('category', sa.Enum('A', 'B', 'C', 'D', name='projectcategory'), nullable=True),
    ...
    sa.ForeignKeyConstraint(['choiceID'], ['question_choices.choiceID'], ),
    ...
    sa.ForeignKeyConstraint(['projectID'], ['projects.projectID'], ),
    sa.ForeignKeyConstraint(['stageID'], ['stage.stageID'], ),
    sa.PrimaryKeyConstraint('projectID', 'stageID')
    )
    op.create_table('project_status_data',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('projectID', sa.Integer(), nullable=False),
